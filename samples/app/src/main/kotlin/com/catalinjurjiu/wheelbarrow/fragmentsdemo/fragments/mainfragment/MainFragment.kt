...
import com.catalinjurjiu.wheelbarrow.fragmentsdemo.fragments.fragment2.Fragment2Factory
import com.catalinjurjiu.wheelbarrow.fragmentsdemo.fragments.fragment2.Fragment2InjectorImpl
import com.catalinjurjiu.wheelbarrow.fragmentsdemo.fragments.mainfragment.childfragment.ChildFragment
import com.catalinjurjiu.wheelbarrow.fragmentsdemo.fragments.mainfragment.childfragment.ChildFragmentFactory
import com.catalinjurjiu.wheelbarrow.fragmentsdemo.fragments.mainfragment.childfragment.ChildFragmentInjectorImpl
 ...
 *
 */
class MainFragment : WheelbarrowFragment<MainFragmentInjector>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.button_goto_fragment2.setOnClickListener {
            val factory = Fragment2Factory(Fragment2InjectorImpl())
    ...
    private fun showChildFragment() {
        ...
        val factory = ChildFragmentFactory(ChildFragmentInjectorImpl())
