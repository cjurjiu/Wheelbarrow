...
import com.catalinjurjiu.wheelbarrow.di.fragmentsdemo.Fragment2Qualifier
 ...
 *
 */
class Fragment2 : WheelbarrowFragment<Fragment2Component>() {

    override val name: String
        get() = TAG

    @Inject
    @field:Fragment2Qualifier
