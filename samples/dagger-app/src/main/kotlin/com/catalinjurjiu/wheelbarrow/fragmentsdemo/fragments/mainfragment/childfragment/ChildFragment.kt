...
import com.catalinjurjiu.wheelbarrow.di.fragmentsdemo.ChildFragmentQualifier
 ...
 *
 */
class ChildFragment : WheelbarrowFragment<ChildFragmentComponent>() {

    override val name: String
        get() = TAG

    @Inject
    @field:ChildFragmentQualifier
